...
describe('RegisterBabyComponent', () => {
  ...
  let mockRegisterBabyService;
  let mockDataService

  beforeEach(async(() => {

    mockRegisterBabyService = sinon.createStubInstance(RegisterBabyService);
    mockRegisterBabyService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: RegisterBabyService, useValue: mockRegisterBabyService },
